<template>
    <div class="container mt-4">
        ...
        <div class="title-options clearfix">
            <h5 class="h5 float-left mb-4">{{ loggedUserRole == "ROLE_PHARMACY_ADMIN" ? 'Farmaceuti u apoteci' : 'Farmaceuti'}}</h5>
...
import PharmacistsFilters from "@/components/filters/PharmacistsFilters.vue"
